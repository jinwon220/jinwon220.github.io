---
title: Javascript_Ajax(1)_XMLHttpRequest
author: JinWon
layout: post
category: JavaScript
---

# Javascript_Ajax(1)_XMLHttpRequest
...
function handleStateChange(){ //callback 함수
...
function sendData(){ 
    ...
    httpReq.onreadystatechange = handleStateChange; //handlerStateChange() <-XXX
    httpReq.open("POST", "Ex01_Resource.html"); //비동기 요청
    httpReq.send();
}
~~~

# XMLHttpRequest_param
...
function HandlerStateChange(){
    ...
    if(httpReq.readyState == 4){ 
        if(httpReq.status >= 200 && httpReq.status < 300){
            ...
            //var view = document.getElementById("div_view");
            //view.innerHTML = httpReq.responseText; //printdata
        }
    }
}
